...
- [x] **1. Wow-moment demo lands on page load**
...
- [x] **5. Destructive filesystem operations**
...
- [x] **6. Remote fetch-and-execute detection**
...
- [x] **8. Outbound network + exfiltration shape**
...
- [x] **9. Sensitive-path redirect detection**
...
- [x] **10. Graceful degradation on unknown syntax**
...
- [x] **11. Design polish — full DESIGN.md implementation**
...
- [x] **13. Static, subpath-deployable build**
